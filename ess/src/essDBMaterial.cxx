   ...
   */
{
  ...
  // ESS 99.5 LIQUIDH2 + 0.5% ortho at 20 K
  MObj.setMaterial(1003, "M01003", " 1001.70c 99.5 1004.70c 0.5 ","hpara.10t hortho.10t", MLib);
  MObj.setDensity(-7.0e-2*(0.07/0.0689677)); // 0.07/0.0689677 because CL for some reason changes the density
  MDB.resetMaterial(MObj);
