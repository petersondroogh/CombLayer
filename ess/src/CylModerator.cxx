...
std::string CylModerator::getLinkComplement(const size_t sideIndex) const
{
  return FixedComp::getLinkComplement(sideIndex);
}

std::string CylModerator::getLinkString(const size_t sideIndex) const
{
...
void CylModerator::addToInsertChain(attachSystem::ContainedComp& CC) const
  /*!
