...
class Wheel : public WheelBase
{
 private:
  ...
  double coolantThickIn;         ///< Thickness of coolant (inner wheel part, near the centre)
  double coolantThickOut;        ///< Thickness of coolant (outer part, near the wheel edge)
  double caseThick;              ///< Case Thickness
  double voidThick;              ///< void surrounding thickness
  
  double innerRadius;            ///< Inner core
  double coolantRadiusIn;        ///< Outer coolant radius (inner part, before step)
  double coolantRadiusOut;       ///< Outer coolant radius (outer part, after step)
