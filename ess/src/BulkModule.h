    ...
    public attachSystem::FixedComp
{
 private:
  ...
  void createSurfaces();
  void createLinks();
  void createObjects(Simulation&,const attachSystem::ContainedComp&, const attachSystem::ContainedComp&);
 ...
 public:
  ...
  int getMainCell() const { return bulkIndex+1; } // kbat: is it correct?
